export interface GameStats {concentration:number;clarity:number;confusion:number;metta:number}
...
export const initialGameStats:GameStats={concentration:0,clarity:0,confusion:0,metta:35};
