...
export const experientialTransitions:ExperientialTransition[]=[
 ...
 T('booboo','mist','The Kindly Shore','balance',[{key:'equanimity',min:28}]),T('booboo','garden','The Grounding Ferry','balance',[{key:'embodiment',min:58}]),T('chasm','mist','The Far End of the Bridge','deconstruction',[{key:'equanimity',min:45}]),T('inn','mist','Enough Argument for Now','balance'),
