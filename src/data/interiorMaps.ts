...
const insightStages:Array<[string,string,string,[number,number]]>=[
 ...
 ['deliverance','Desire for Deliverance','A narrow doorway appears, marked simply: OUT.',[1,0]],['reobservation','Re-observation','All the difficult rooms return together. Keep walking gently.',[1,0]],['equanimity','Equanimity','The floor opens wide; phenomena come and go without a quarrel.',[2,0]],['conformity','Conformity','Attention aligns with the path like tumblers in a lock.',[2,0]],
 ['change-lineage','Change of Lineage','One last threshold separates the familiar from the uncharted.',[2,0]],['path','Path','A single decisive step cuts through the old circuit.',[2,0]],['fruition','Fruition','The map blanks for a moment; afterward, the world resumes.',[2,0]],['review','Review','At the final balcony, retrace what happened without decorating it.',[2,0]]
];
...
export const interiorMaps:InteriorMap[]=[
 {id:'insight-tower-world',regionId:'tower',name:'The Tower of Insight',theme:'tower',floors:[
  ...
  floor('progress','Floor II · The Progress of Insight','Sixteen chambers spiral from first distinctions through review',grid(insightStages,4,260,150,360,220),1600,1080),
