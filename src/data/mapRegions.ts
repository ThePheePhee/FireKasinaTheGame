...
export const mapRegions:Region[]=[
 ...
 {id:'celestial',name:'The Divine Abodes',x:1250,y:120,radius:150,terrain:'celestial'},
 ...
 {id:'booboo',name:'Boohoo Lagoon',x:650,y:820,radius:170,terrain:'lagoon'},
 {id:'healing',name:'The Healing Meadows',x:230,y:900,radius:150,terrain:'meadow'},
 {id:'jhana',name:'Jhana Range',x:1050,y:900,radius:145,terrain:'hills'},
