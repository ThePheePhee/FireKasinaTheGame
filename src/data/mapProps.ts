...
const baseMapProps:MapProp[]=[
 ...
 {id:'arcadian-gate',name:'The Arcadian Gate',x:1285,y:115,size:82,art:[0,1],copy:'Beyond the gate lies a garden gentler than memory. Enter with compassion as your quest-marker; marvelous sights are better when they teach the heart where to point.',reference:{label:'Gabe’s Joshua Tree diary',url:'https://firekasina.org/diaries/joshua-tree-retreat-2016/diary-gabe-miller/'}},
 {id:'two-color-banner',name:'The Ebbing Banner',x:265,y:225,size:64,art:[1,1],copy:'Orange advances. Violet retreats. Then they trade places like a tide inside the visual field. The banner calls this “ebbing”; it refuses to hold still for a portrait.',reference:{label:'2015 retreat summary',url:'https://firekasina.org/2015/02/17/retreat-summary/'}},
