...
const baseAmbientProps:{x:number;y:number;size:number;art:[number,number];alpha:number}[]=[
 {x:140,y:360,size:42,art:[3,1],alpha:.72},{x:430,y:735,size:38,art:[1,1],alpha:.62},
