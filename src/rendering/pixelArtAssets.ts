type AtlasName='player'|'landmarks';
...
export function onPixelArtReady(listener:()=>void){listeners.add(listener);if(ready.size===2)queueMicrotask(listener);return()=>{listeners.delete(listener)}}
