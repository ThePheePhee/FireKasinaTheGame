...
export default function App(){
 ...
 return <main className={`game experience-${experience}`}>
  ...
  {interior&&<InteriorMode map={interior} onExit={()=>setInterior(null)}/>} {overview&&<SubMap map={overview} onExit={()=>setOverview(null)}/>} {practicing&&<RedDotMinigame stats={gameStats} onChange={onGameStatsChange} onExit={()=>setPracticing(false)}/>} {traumaGame&&<TraumaLabyrinth stats={gameStats} onChange={onGameStatsChange} onExit={()=>setTraumaGame(false)}/>}
 </main>;
}
