...
export default function App(){
 ...
 const region=selection?.kind==='region'?selection.region:null,route=selection?.kind==='route'?selection.route:null,lore=route?pathContent[route.id]:null,interiorEntrance=region?getInteriorMap(region.id):undefined;
