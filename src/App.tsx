...
export default function App(){
 ...
 return <main className={`game experience-${experience}`}>
  ...
  {isGame&&<GameHud stats={gameStats} mistOverride={mistOverride} fairyOverride={fairyOverride} onMistOverride={setMistOverride} onFairyOverride={setFairyOverride}/>}<aside className="help">{view==='player'?<>MOVE <kbd>WASD</kbd> <kbd>↑↓←→</kbd></>:<>TAP REGIONS & PATHS · DRAG · PINCH</>}</aside>
